                ...
                >   
                    <b-tab title="1. Generar documento" title-item-class="disabledTab" :disabled="tabIndex2 < 0">
                        <generacion_documento                                        
                            ...
                            nombre_archivo_pdf="acta_conformidad_redaccion_tesis.php"
                            boton_nombre="Acta conformidad redacción"
                            ref="documentos"
                        />                      
                    </b-tab>  
                    <b-tab title="2. Añadir documento" title-item-class="disabledTab" :disabled="tabIndex2 < 1">
                        <documentos               
                            ...
                            ref="documentos"
                            max_docs = "1"
                            nombre_asignado = "Acta de conformidad de redacción de tesis"
                        />
