  ...
  <div>        
    <b-card no-body>
      <b-tabs pills card align="center">
        <b-tab title="Denegar Expediente" @click="accion='denegar'">
          <b-card no-body>
            <b-tabs 
                v-model="tabIndex" 
                card        
                    ...
                    <div class="row">
                        <div class="mx-auto"> 
                            <b-button @click="generarPdf" variant="success">
                                <b-icon icon="file-earmark-text"></b-icon> Renuncia de asesoria
                            </b-button> 
                        </div>
                    </div>
                </b-tab>      
        ...
        <b-tab title="Aceptar Expediente" active @click="accion='aceptar'">
          <div class="text-center">
            <template v-for="(ruta, index) in array_ruta">                            
              <div :key="index" v-if="ruta.etiqueta == accion">
                <b-row class="justify-content-lg-center">
...
export default {      
  ...
  data() {
    return {                  
        ...
        url_pdf : `${this.$root.API_URL}/pdfs/titulo_profesional_sustentacion_tesis/informe_renuncia_asesoria.php`,
  ...
  methods: {        
    ...
    registrarDocumento() {         
        let me = this                      
        let formData = this._toFormData({
            nombre: 'Informe renuncia de asesoria',
            data: this.file,
            idgrado_proc: this.idgrado_proc,
            idusuario: this.idusuario,
            idexpediente: this.expediente.id
