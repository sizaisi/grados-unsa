  ...
  <div>
     <div class="container pt-2 pb-3" style="background-color: #fff;">
        ...
        <div class="row">
          <div class="col-lg-12">
                <b-table
                  id="tbl-modalidad-obtencion"
                  :items="array_modalidad_obtencion"
                  :fields="columnas"
      ...
      <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                  ...
                  <button v-if="tipoAccion=='registrar'" type="button" @click="registrarModalidadObtencion" class="btn btn-success">Guardar</button>
                  <button v-if="tipoAccion=='actualizar'" type="button" @click="actualizarModalidadObtencion" class="btn btn-success">Actualizar</button>
              </div>
            </div>
      </div>
    </div>
        ...
        <div class="modal-content">
          <form>
            ...
            <div class="modal-body">
              ...
              <p class="font-weight-bold text-center" v-text="modalidad_obtencion.nombre"></p>
            </div>
            <div class="modal-footer">
              <b-button variant="secondary" @click="cerrarDeleteModal">Cancelar</b-button>
              <b-button variant="success" @click="anularModalidadObtencion">Aceptar</b-button>
            </div>
          </form>
        </div>
      </div>
     ...
     methods: {
        ...
        abrirAddEditModal(accion, data = []) {
            ...
            switch(accion) {
                case 'registrar':
                {
                    this.titleAddEditModal = 'Registrar Modalidad de Obtención'
                    this.modalidad_obtencion.id = ''
                    this.modalidad_obtencion.nombre = ''
                    this.tipoAccion = 'registrar'
                    break
                }
                case 'actualizar':
                {
                    this.titleAddEditModal = 'Actualizar Modalidad de Obtención'
                    this.modalidad_obtencion.id = data.id
                    this.modalidad_obtencion.nombre = data.nombre
        ...
        abrirDeleteModal(accion, data = []) {
            ...
            switch(accion) {
                case 'activar':
                {
                    this.titleDeleteModal = 'Activar Modalidad de Obtención'
                    this.messageDeleteModal = '¿Desea activar esta modalidad de obtención?'
                    this.modalidad_obtencion.id = data.id
                    this.modalidad_obtencion.nombre = data.nombre
                ...
                case 'desactivar':
                {
                    ...
                    this.messageDeleteModal = '¿Desea desactivar esta modalidad de obtención?'
                    this.modalidad_obtencion.id = data.id
                    this.modalidad_obtencion.nombre = data.nombre
